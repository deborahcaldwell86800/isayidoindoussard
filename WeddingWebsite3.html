...
.bgimg {background-image: url("http://i67.tinypic.com/dqnw1.jpg")}
.bgimg2 {background-image: url("http://i65.tinypic.com/1ta7v6.jpg")}
.bgimg4 {background-image: url("http://i67.tinypic.com/900wom.jpg")}
</style>
<body>
...
<header class="w3-display-container w3-wide bgimg w3-grayscale-min" id="home">
  ...
  <h2 class="w3-wide">We’re Getting Married</h2>
  <p class="w3-opacity">Deborah & Graham</p>
  <p class="w3-opacity"><i>16 June 2018 | Doussard, Lake Annecy | France</i></p>  </div>
</header>
...
<div class="w3-bottom w3-hide-small">
  <div class="w3-bar w3-white w3-center w3-padding w3-opacity-min w3-hover-opacity-off">
    ...
    <a href="#us" style="width:25%" class="w3-bar-item w3-button">Deborah & Graham</a>
...
<!-- About / Deborah and Graham -->
<div class="w3-container w3-padding-64 w3-pale-red w3-grayscale-min" id="us">
  <div class="w3-content">
    <h1 class="w3-center w3-text-grey"><b>Deborah & Graham</b></h1>
    <img class="w3-round w3-grayscale-min" src="/w3images/wedding_couple2.jpg" style="width:100%;margin:32px 0">
    <p><i>You all know us. And we all know you. We are getting married on the lakeside of Lac D’Annecy.</i>
    </p><br>
...
<div class="w3-container w3-padding-64 w3-pale-red w3-grayscale-min w3-center" id="wedding">
  <div class="w3-content">
    ...
    <div class="w3-row">
      ...
      <div class="w3-half">
        <h2>Where</h2>
        <p>Doussard, Lake Annecy, France</p>
        <p>Closest airport: Geneva, Switzerland</p>
      </div>
    </div>
  </div>
</div>
...
<div id="id01" class="w3-modal">
  <div class="w3-modal-content w3-card-4 w3-animate-zoom" style="padding:32px;max-width:600px">
    <div class="w3-container w3-white w3-center">
      ...
      <p><i>Sincerely, Deborah & Graham</i></p>
      <div class="w3-row">
        <div class="w3-half">
